...
extension Value: ValueConvertible {
    ...
    public init(ethereumValue: Value) {
        self = ethereumValue
    }
...
extension Value._Type: Equatable {

    public static func ==(_ lhs: Value._Type, _ rhs: Value._Type) -> Bool {
        switch lhs {
        case .string(let str):
...
extension Value._Type: Hashable {
